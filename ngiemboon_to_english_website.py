...
def extract_sensecontent(line_dictionnary):
    ...
    for sense in line_dictionnary.find_all("span", class_="sensecontent"):
        ...
        for example in sense.find_all("span", class_="examplescontent"):            
            ...
            example_fr = extract_span_text_from_attribut_value(example.find("span", class_="translationcontent"), "lang", "fr")
            example_en = extract_span_text_from_attribut_value(example.find("span", class_="translationcontent"), "lang", "en")
